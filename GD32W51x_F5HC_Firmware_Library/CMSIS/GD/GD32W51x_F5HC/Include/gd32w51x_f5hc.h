/*!
    \file    gd32w51x_f5hc.h
    \brief   general definitions for gd32w51x_f5hc
...
#ifndef GD32W51x_F5HC_H
#define GD32W51x_F5HC_H
...
#define IRC48M_STARTUP_TIMEOUT   ((uint16_t)0x0500U)
#endif /* internal 48MHz RC oscillator startup timeout */

/* define value of high speed crystal oscillator (CKEXT) in Hz */
#if !defined  (CKEXT_VALUE)
#define CKEXT_VALUE    ((uint32_t)16000000)
#endif /* high speed crystal oscillator value */

/* define startup timeout value of high speed crystal oscillator (CKEXT) */
#if !defined  (CKEXT_STARTUP_TIMEOUT)
#define CKEXT_STARTUP_TIMEOUT   ((uint16_t)0xFFFFU)
#endif /* internal CKEXT startup timeout */ 
...
#define __gd32w51x_f5hc_STDPERIPH_VERSION_MAIN   (0x02) /*!< [31:24] main version */
#define __gd32w51x_f5hc_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __gd32w51x_f5hc_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __gd32w51x_f5hc_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __gd32w51x_f5hc_STDPERIPH_VERSION        ((__gd32w51x_f5hc_STDPERIPH_VERSION_MAIN << 24)\
                                            |(__gd32w51x_f5hc_STDPERIPH_VERSION_SUB1 << 16)\
                                            |(__gd32w51x_f5hc_STDPERIPH_VERSION_SUB2 << 8)\
                                            |(__gd32w51x_f5hc_STDPERIPH_VERSION_RC))
...
typedef enum IRQn
{
...
#if defined (GD32F5HC)
    TAMPER_STAMP_LXTAL_IRQn     = 2,      /*!< RTC tamper and timestamp events interrupt and LXTAL clock blocking */
#else
    ...
    I2C1_WKUP_IRQn              = 65,     /*!< I2C1 Wakeup interrupt*/ 		
#if defined (GD32W515)
...
/* includes */
#include "core_cm33.h"
#include "system_gd32w51x_f5hc.h"
#include <stdint.h>
#ifdef FW_DEBUG_ERR_REPORT
#include "gd32w51x_f5hc_err_report.h"
...
#define CTC_BASE_NS              (APB1_BUS_BASE_NS + 0x00006C00U)  /*!< CTC base address */
...
#define CTC_BASE_S              (APB1_BUS_BASE_S + 0x00006C00U)    /*!< CTC base address */
...
#define CTC_BASE              CTC_BASE_S                           /*!< CTC base address */
...
#define CTC_BASE              CTC_BASE_NS                          /*!< CTC base address */
...
#include "gd32w51x_f5hc_libopt.h"
#endif /* USE_STDPERIPH_DRIVER */

#ifdef __cplusplus
}
#endif
#endif /* GD32W51x_F5HC_H */
